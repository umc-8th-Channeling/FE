        ...
        <div className="flex flex-col gap-10 w-full">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="font-title-20b">찰스엔터</div>
                </div>
                <div className="flex flex-col gap-2">
                    <Label className="font-body-16b text-gray-600">이메일</Label>
                    <div className="font-title-20b">kjh213513@gmail.com</div>
                </div>
            </div>
            ...
            <div className="desktop:pb-6">
                <button className="w-full font-title-18b flex items-center justify-between" onClick={onWithdraw}>
                    <span>탈퇴하기</span>
                    <SendIcon />
                </button>
            </div>
